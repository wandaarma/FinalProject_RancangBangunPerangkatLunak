...
<head>
    ...
    <title>Mytask Overview</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/mytask/overview.css') }}">
...
<body>
    <div class="template1">
        ...
        <div class="vertical-nav" id="sidebar">
            <li class="nav-item">
                <a href="{{ url('mytask') }}" class="nav-link active">
        ...
        <div class="main1">
            <div class="main2">
                <div class="overview">
                    @foreach ($data_individu as $di)
                    <p class="title">{{ $di->title }}</p>
                    <p class="description">Description</p>
                    <p class="descriptiontext">{{ $di->description }}</p>
                    <p class="description">Subtask</p>
                    <p class="descriptiontext">{{ $di->subtask }}</p>
                    <p class="description">Deadline</p>
                    <p class="descriptiontext">{{ $di->deadline }}</p>
                    <p class="description">Status</p>
                    <p class="descriptiontext">{{ $di->status }}</p>
                    @endforeach
                    </div>
                </div>
            </div>
