                ...
                <div class="container">
                    <form action="/mytask/storetask" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Enter description" rows="6"
                                required="required"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="subtask">Subtask:</label>
                            <input type="text" class="form-control" name="subtask" id="subtask"
                                placeholder="Enter subtask" required="required">
                        </div>
                        <div class="form-group">
