...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/workspace/overview.css') }}">
                ...
                <div class="dropdown-menu">
                    @forelse ($data_kelompok as $dk)
                        <a class="dropdown-item"
                            href="{{ url('workspace/overview/' . $dk->id . '/') }}">{{ $dk->title }}</a>
                    @empty
                    @endforelse
                </div>
            </div>
            ...
            <div class="main2">
                <div class="overview">
                    @foreach ($data_kelompok as $dk)
                        ...
                        <p class="descriptiontext">{{ $dk->description }}</p>
                        <p class="description">Subtask</p>
                        <p class="descriptiontext">{{ $dk->subtask }}</p>
                        <p class="description">Deadline</p>
                        <p class="descriptiontext">{{ $dk->deadline }}</p>
                        <p class="description">Status</p>
                        <p class="descriptiontext">{{ $dk->status }}</p>
                        <p class="description">Priority</p>
                        <p class="descriptiontext">{{ $dk->priority }}</p>
                    @endforeach
                </div>
            </div>
        </div>
