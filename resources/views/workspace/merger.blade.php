...
<head>
    ...
    <title>Merger</title>
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/workspace/merger.css') }}">
    <link href="https://fonts.googleapis.com/css?family=Poppins&display=swap" rel="stylesheet" />
    <link href="./css/main.css" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.2/css/font-awesome.css" <blade
        ___scripts_0___ />
    <meta name="viewport" content="width=device-width, initial-scale=1">
        ...
        <div class="main1">
            <div class="main2">
                <div class="merger">
                    ...
                    @foreach ($data_kelompok as $dk)
                        <p class="title">{{ $dk->title }}</p>
                    @endforeach

                    <div class="kotak1">

                        <form method="post" action="{{ route('uploadedfile.store') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="file" name="Dokumen[]" id="file-input" class="myfrm form-control"
                                multiple="">
                            <button type="submit" class="btn btn-success" style="margin-top:10px">Download</button>
                        </form>
                    </div>
                </div>
            </div>
